...
- Canonical repo target: `kotlin-minilog`. Useful entrypoints: `dev project show kotlin-minilog`, `dev build kotlin-minilog`, `dev check kotlin-minilog`.
- Setup-managed files are regenerated with `dev setup kotlin-minilog`; avoid hand-editing stamped generated files.
